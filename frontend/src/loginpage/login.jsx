  ...
  const handleLogin = async (data, isGoogle = false) => {
    try {
      ...
      const endpoint = isGoogle
        ...
        : "http://localhost:8000/auth/login"; // Use the correct endpoint
      ...
      if (response.ok) {
        ...
        setError(errorData.detail || (isGoogle ? "Google login failed" : "Invalid credentials"));
      }
    } catch (error) {
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/2 bg-white flex flex-col justify-center items-center">
        <img src={logo} alt="NEPSE Navigator Logo" className="w-20 h-20 mb-4" />
